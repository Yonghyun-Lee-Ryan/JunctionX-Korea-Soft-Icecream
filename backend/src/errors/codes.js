...
export const ERROR_CODES = {
  ...
  E_AGENT_API_NOT_CONFIGURED: { status: 503, message: 'Agent API 전용 키가 설정되지 않았습니다.' },
  E_AGENT_RATE_LIMITED: { status: 429, message: 'Workflow Agent API 호출이 너무 많습니다. 잠시 후 다시 시도해 주세요.' },
  E_AGENT_BUSY: { status: 429, message: 'Workflow Agent 작업이 모두 사용 중입니다. 잠시 후 다시 시도해 주세요.' },
  E_AGENT_OUTPUT_INVALID: { status: 502, message: 'Agent가 올바른 형식의 결과를 반환하지 않았습니다.' },
